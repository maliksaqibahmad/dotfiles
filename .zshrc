...
alias update='sudo pacman -Syu && yay -Syu && yay -Yc'   # Full system update with cleaning
...
# Reload .tmux.conf
alias nooo='tmux source-file ~/.tmux.conf && echo ".tmux.conf sourced"'
...
# OpenSSH
alias phone="ssh u0_a326@xiaomi -p 8022"
...
export PATH=$PATH:/home/saqib/.spicetify
